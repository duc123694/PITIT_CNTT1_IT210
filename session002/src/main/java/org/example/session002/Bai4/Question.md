...
XSS (Cross-Site Scripting): Là lỗ hổng cho phép kẻ tấn công chèn các đoạn mã script độc hại (thường là JavaScript) vào trang web. Khi người dùng khác xem trang, trình duyệt sẽ thực thi đoạn mã này.
