Cấu trúc đối tượng Dish
Đối tượng Dish được thiết kế theo chuẩn POJO để mang dữ liệu từ Service qua Controller đến View.
...
Sơ đồ luồng I/O (Input/Output)
Dưới đây là cách dữ liệu di chuyển trong hệ thống:

Input: Client gửi request đến URL /bai2/dishes.

Processing: * DishController gọi DishService để lấy danh sách List<Dish>.
